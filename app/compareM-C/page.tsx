          ...
          <Section id="components" title="Components" intro="Mistral: utility-first, 2 component tokens. Columbus: M3 ships 8 component token sets but 0 refs in code.">
            <Pair>
              <MistralCol>
                ...
                <div className="space-y-2">
                  <button className="px-4 py-2 bg-mistral-black text-white text-sm rounded-[7px] hover:bg-mistral-black/80">Primary</button>
                  <button className="px-4 py-2 ml-2 bg-mistral-orange text-white text-sm rounded-[7px]">Accent</button>
                  <button className="px-4 py-2 ml-2 border border-current text-mistral-black text-sm rounded-[7px]">Outlined</button>
                </div>
                <p className="text-xs mt-4 text-mistral-black-tint">
