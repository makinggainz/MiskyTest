...
const radiusScale = [
  { token: "--radius-sm", value: "9999px — buttons, chips, badges (pill)", className: "rounded-full" },
      ...
      <div className="container max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-12">
        ...
        <div>
          ...
          <Section
            id="radius"
            title="Border radius"
            intro="Pill corners on interactive elements — buttons, chips, and badges all use rounded-full (9999px). Layout containers stay square."
          >
            <Usage status="partial">
              Two split rules: <strong>layout containers stay square</strong> (no <code className="font-mono text-xs">rounded-*</code> on sections, surfaces, carousel tiles); <strong>interactive elements use pill corners</strong> (<code className="font-mono text-xs">rounded-full</code> — every button, chip-labels, badges, and the Try Studio split-button wrapper). See §8.1 in design-system.md for the full rule.
            </Usage>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-mistral-black text-white p-6 rounded-full md:col-span-2 h-48 flex flex-col justify-between relative overflow-hidden" style={{ background: "linear-gradient(135deg, #1f1f1f 0%, #154ACC 200%)" }}>
                <div className="text-xs font-mono text-white/70">card-photographic · rounded-full (--radius-xl, large photographic surfaces)</div>
                <div>
                  <h4 className="text-2xl font-medium">Photographic dark card</h4>
                  <p className="text-sm text-white/70 mt-2">Customer story pattern. Large photographic surfaces use --radius-xl. overflow-hidden clips the photo to the rounded corners.</p>
                </div>
              </div>
            </div>
