...
const buttonVariants = [
  { name: "Primary", className: "border border-mistral-black bg-transparent text-mistral-black hover:bg-mistral-black/5 px-5 py-2 text-sm rounded-[8px] transition-colors", label: "Get started" },
      ...
      <div className="container max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-12">
        ...
        <div>
          ...
          <Section
            id="radius"
            title="Border radius"
            intro="8px corners on interactive elements — --radius defaults to 0.5rem (8px). Buttons, chips, and badges all use rounded-[8px]; layout containers stay square."
          >
            <Usage status="partial">
              Two split rules: <strong>layout containers stay square</strong> (no <code className="font-mono text-xs">rounded-*</code> on sections, surfaces, carousel tiles); <strong>interactive elements use 8px corners</strong> (<code className="font-mono text-xs">rounded-[8px]</code> — every button, chip-labels, badges, and the Try Studio split-button wrapper). <code className="font-mono text-xs">--radius</code> anchor is now <code className="font-mono text-xs">0.5rem</code> (8px). See §8.1 in design-system.md for the full rule.
            </Usage>
...
const response = await client.chat({ model: "mistral-large-latest", messages: [...] });`}</pre>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-mistral-beige border border-mistral-beige-deep p-xl rounded-md">
                ...
                <button className="mt-4 border border-mistral-black bg-transparent text-mistral-black px-5 py-2 text-sm rounded-[8px] hover:bg-mistral-black/5 transition-colors">Contact Sales</button>
              </div>
            </div>
          </Section>
