...
export function Nav() {
  // Mistral's nav slides down a white backdrop once you scroll past the hero.
  ...
  // Color theme: white text over dark hero, black text over white scrolled bg
    ...
    <header className="fixed z-999 top-0 left-0 w-full">
      ...
      <div className="px-4 md:px-auto md:container flex items-center gap-6 justify-between py-6 relative z-10">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <a
            target="_self"
            className={`group px-4 py-2 text-sm hidden md:flex items-center truncate gap-2 transition-colors ${
              scrolled
          ...
          >
            ...
            <span className="ml-2 inline-block transition-transform group-hover:translate-x-0.5">
              <ArrowDot className={scrolled ? "text-mistral-black group-hover:text-white" : "text-white group-hover:text-mistral-orange"} />
            </span>
          </a>
          ...
          <div className="relative hidden md:block" {...navItemTriggerProps("studio")}>
            <div className={`group flex items-center text-sm transition-colors ${scrolled ? "bg-mistral-black/10 text-mistral-black" : "bg-white/10 text-white"}`}>
              <a
                target="_blank"
                rel="noopener"
          ...
          {/* Mobile menu trigger */}
          <button
            className={`lg:hidden md:px-2 cursor-pointer ${scrolled ? "text-mistral-black" : "text-white"}`}
      ...
      {mobileOpen && (
        <div className="lg:hidden absolute top-full left-0 w-full bg-background text-mistral-black z-20 px-6 py-6 shadow-lg max-h-[calc(100vh-100px)] overflow-y-auto">
          <ul className="flex flex-col gap-1">
            ...
            <li className="mt-6">
              <a href="https://mistral.ai/contact" className="block px-4 py-2 bg-mistral-black text-white text-sm text-center">
                Contact Sales
              </a>
            </li>
            <li className="mt-2">
              <a href="https://console.mistral.ai/" target="_blank" rel="noopener" className="block px-4 py-2 bg-mistral-orange text-white text-sm text-center">
                Try Studio
              </a>
            </li>
          </ul>
