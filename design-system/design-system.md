...
| `--radius-sm` | `9999px` | `rounded-full` | **Chips, badges, role pills, tabs, decorative circles** — pill shape |
| (new) | `7px` | `rounded-[7px]` | **CTA buttons** (primary, accent, on-cream, on-dark, outline) |
...
**Rules:**
- **CTA buttons use `rounded-[7px]`** — primary, accent, on-cream, on-dark glass, and outline call-to-action buttons.
...
- **Scale by visual size:** CTA button → 7px; chip/badge → pill; small panel/input → 10px; card/dialog → 20px; large photo → 8px; hero container → 9px.
